  ...
  static defaultProps = {
	...
	renderCustomPagination(locale) {
		console.log("renderPagination")
			...
			return React.createElement(CustomRcPagination, _extends({}, restProps, { className: classNames(className, { mini: isSmall }), selectComponentClass: isSmall ? MiniSelect : Select, locale: locale }));
