    ...
    _createClass(BaseForm, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          return React$1__default.createElement(_Form, otherProps, children);
        }
      }
    ]);
    ...
    _createClass(WrapperDatePicker, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          return React$1__default.cloneElement(
            children,
        ...
        value: function renderPanel() {
          ...
          if (inside) {
            ...
            return React$1__default.createElement(
              ...
              React$1__default.createElement(Search, {
                style: {
                  marginBottom: 8
                },
                placeholder: 'Search',
    ...
    _createClass(Permission, [
      {
        ...
        value: function render() {
          ...
          var childrenWithProps = expression
            ? React$1__default.Children.map(this.props.children, function(
                child
              ) {
      ...
      },
      {
        ...
        value: function getFields() {
          ...
          if (this.state.expand == false) {
            ...
            //高级配置后，前三固定 后四配置
            renderChildren = React$1__default.Children.toArray(children).filter(
              function(ch, idx) {
          ...
          return React$1__default.createElement(
            ...
            children.length > 3
              ? React$1__default.createElement(
                  ...
                  React$1__default.createElement(_Icon, {
                    type: expand ? 'up' : 'down'
                  })
                )
              : ''
    ...
    _createClass(Panel, [
      {
        ...
        value: function renderHeader() {
          ...
          if (title || extra) {
            header = React$1__default.createElement(
              'div',
              {
      ...
      },
      {
        ...
        value: function renderFooter(locale) {
          ...
          if (props.footer != false) {
            footer = React$1__default.createElement(
              'div',
              {
        ...
        value: function renderModule(child) {
          ...
          return React$1__default.createElement(
            ...
            typeof childProps.children === 'function'
              ? React$1__default.createElement(childProps.children, otherProps)
              : React$1__default.cloneElement(childProps.children, otherProps)
          );
        }
      },
      {
    ...
    _createClass(PropertyTable, [
      {
        ...
        value: function renderItem(ds, idx) {
          return React$1__default.createElement(
            ...
            React$1__default.createElement('th', null, ds.label),
            React$1__default.createElement('td', null, ds.value)
          );
        }
      },
      {
      ...
      _defineProperty$1(_assertThisInitialized(_this2), 'render', function() {
        ...
        return React$1__default.createElement(
          ...
          [
            ...
            React$1__default.createElement(_Input, {
    ...
    function NewTransferList(props) {
      ...
      _defineProperty$1(_assertThisInitialized(_this4), 'render', function() {
        ...
        var showItems = dataSource.map(function(item) {
          ...
          return React$1__default.createElement(Item, {
            key: item.key,
            item: item,
            lazy: lazy,
        ...
        var search = showSearch
          ? React$1__default.createElement(
              ...
              React$1__default.createElement(NewTransferSearch, {
        ...
        var checkAllCheckbox = React$1__default.createElement(_Checkbox, {
      ...
      _this4.refCheckbox = React$1__default.createRef();
      return _this4;
    }
      ...
      _defineProperty$1(
        ...
        function(locale) {
          ...
          return React$1__default.createElement(
            ...
            React$1__default.createElement(NewTransferList, {
            ...
            React$1__default.createElement(Operation, {
  ...
  (function(_React$Component) {
    ...
    function TransferView() {
      ...
      _defineProperty$1(_assertThisInitialized(_this6), 'renderItem', function(
        ...
        var customLabel = React$1__default.createElement(
          'div',
          {
...
var EditableCell =
  ...
  (function(_React$Component) {
    ...
    function EditableCell() {
      ...
      _this = _possibleConstructorReturn$1(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(EditableCell)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
      ...
      _defineProperty$1(
        ...
        function(td) {
          var _this$props = _this.props,
            ...
            changeColumnEditStatus = _this$props.changeColumnEditStatus;
    ...
    _createClass(EditableCell, [
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            editDom = _this$props2.editDom,
            editConfig = _this$props2.editConfig,
            editingStatus = _this$props2.editingStatus,
            changeColumnEditStatus = _this$props2.changeColumnEditStatus,
            clickEditable = _this$props2.clickEditable,
                ...
                _extends$1({}, restProps, {
                  onDoubleClick:
                    editing || editingStatus || !clickEditable
                      ? function() {}
                      : function() {
                          return _this2.onDoubleClick(_this2);
                        }
                }),
                editing
                  ? React$1__default.createElement(
...
var EditTable =
  ...
  (function(_React$Component2) {
    ...
    function EditTable(props) {
      ...
      _defineProperty$1(_assertThisInitialized(_this3), 'isEditing', function(
        record
      ) {
        return record.key === _this3.state.editingKey;
      });

      _defineProperty$1(_assertThisInitialized(_this3), 'edit', function(key) {
        if (_this3.state.editingKey !== '') {
      ...
      _defineProperty$1(_assertThisInitialized(_this3), 'editColumn', function(
        key
      ) {
        if (_this3.state.editingKey !== '') {
          _message.error('请先保存编辑项再进行其他编辑操作！');
      ...
      _defineProperty$1(
        ...
        function(record, tdObject) {
          _this3.editColumn(record.key);

          _this3.state.columns.map(function(item) {
      ...
      _defineProperty$1(_assertThisInitialized(_this3), 'cancel', function(
        form,
        key
      ) {
        var obj = _this3.state.data.filter(function(d) {
          return d.key === key;
        })[0];
      ...
      _defineProperty$1(_assertThisInitialized(_this3), 'addNew', function() {
        if (_this3.state.editingKey !== '') {
        ...
        var keyList = _toConsumableArray(_this3.state.keyList);
        /* istanbul ignore else */
        ...
        var data = _toConsumableArray(_this3.state.data);
                        ...
                        function(form) {
                          return React$1__default.createElement(
                            _Popconfirm,
                            {
                              title: '\u786E\u8BA4\u53D6\u6D88?',
                              onConfirm: function onConfirm() {
                                return _this3.cancel(form, record.key);
                              }
                            },
                            React$1__default.createElement(
                              'a',
                  ...
                  : React$1__default.createElement(
                      ...
                      React$1__default.createElement(
                        _Popconfirm,
                        {
                          title: '\u786E\u8BA4\u5220\u9664?',
                          onConfirm: function onConfirm() {
                            return _this3['delete'](record.key);
                          }
                        },
                        React$1__default.createElement(
                          'a',
        ...
        value: function componentDidMount() {
          ...
          if (this.props.columns && this.props.columns.length > 0) {
            this.setState(
              ...
              function() {
                var keyList = _this4.state.columns.map(function(c) {
                  return c.dataIndex;
                });
      ...
      },
      {
        ...
        value: function _delete(key) {
          ...
          this.setState(
            ...
            function() {
              _this5.props.onChange(_this5.state.data);
            }
          );
        }
      },
      {
        ...
        value: function save(form, key) {
          ...
          form.validateFields(function(error, row) {
            ...
            var newData = _toConsumableArray(_this6.state.data);
            ...
            return _objectSpread2({}, col, {
              onCell: function onCell(record) {
                return {
                  ...
                  title: col.title,
                  editing: _this7.isEditing(record),
                  editingStatus: col.editingStatus,
                  changeColumnEditStatus: _this7.changeColumnEditStatus,
                  clickEditable: _this7.props.clickEditable
                };
              }
            });
          });
          return React$1__default.createElement(_Table, {
...
var UpDown = function UpDown(_ref) {
  ...
  return React$1__default.createElement(_Icon, {
    type: 'down',
    className: down,
            ...
            React$1__default.createElement(
              ...
              this.props.display === undefined
                ...
                : React$1__default.createElement(
                    ...
                    this.props.title,
                    React$1__default.createElement(UpDown, {
...
var ConditionForm =
  ...
  (function(_PureComponent) {
    ...
    function ConditionForm(props) {
      ...
      _this = _possibleConstructorReturn$1(
        this,
        _getPrototypeOf(ConditionForm).call(this, props)
      );
      ...
      _defineProperty$1(_assertThisInitialized(_this), 'addSql', function() {
        ...
        var nextV = !sqlTextarea
          ? sql
          : sqlTextarea + ' '.concat(ao, ' ').concat(sql);
        ...
        value: function render() {
          if (this.state.errorInfo) {
            ...
            return React$1__default.createElement(
              'div',
              null,
              React$1__default.createElement('h2', null, '\u51FA\u9519\u4E86.'),
              React$1__default.createElement(
                'details',
                {
                  style: {
    ...
    _createClass(FormItemFixed, [
      {
        key: 'render',
        value: function render() {
          var firstChildType = React$1__default.Children.toArray(
            this.props.children
          ).length
            ? _typeof(React$1__default.Children.toArray(this.props.children)[0])
            : 'string';
      ...
      _defineProperty$1(
        ...
        function(data) {
          return data.map(function(item) {
            ...
            return React$1__default.createElement(TreeNode$1, item);
          });
        }
      );
        ...
        value: function render() {
          ...
          return React$1__default.createElement(
            _Card,
            {
              size: 'small',
              title: title,
              extra: React$1__default.createElement(
                _Checkbox,
                {
      ...
      },
      {
        ...
        value: function renderExtra() {
          ...
          return this.isExtraIsReactDom(control)
            ? React$1__default.createElement(FormItem, {}, control)
            : control;
        }
      },
      {
...
var ref = React$1__default.createRef();
          ...
          return React$1__default.createElement(
            ...
            React$1__default.createElement(
              ...
              steps.map(function(item) {
                return React$1__default.createElement(_Steps.Step, {
                  key: item.text,
                  title: item.text,
        ...
        value: function renderDom() {
          ...
          return React$1__default.createElement(
            ...
            React$1__default.createElement(
              ...
              React$1__default.createElement(_Col, {
                span: 2
              }),
              React$1__default.createElement(
                _Col,
