...
stories.add(
  ...
  () => (
    <Pane>
      <Input style={{position: "absolute", left: 10, top: 0}} placeholder="第一个输入框"/>
      <Input style={{position: "absolute", left: 10, top: 40}} placeholder="第二个输入框"/>
      <Input style={{position: "absolute", left: 10, top: 80}} placeholder="第三个输入框"/>
      <Input style={{position: "absolute", left: 10, top: 120}} placeholder="第四个输入框"/>
      <Input style={{position: "absolute", left: 10, top: 160}} placeholder="第五个输入框"/>
    </Pane>
  ),
);
